...
class TestReadGPF(unittest.TestCase):
    ...
    def test_read(self):
        GPF_0 = ReadGPF(os.path.join(CWD,'Data/grid-format-0-original.gpf'),loglevel=100)
        GPF_1 = ReadGPF(os.path.join(CWD,'Data/grid-format-1-simplest.gpf'),loglevel=100)
        GPF_2 = ReadGPF(os.path.join(CWD,'Data/grid-format-2-goodfull.gpf'),loglevel=100)
        GPF_3 = ReadGPF(os.path.join(CWD,'Data/grid-format-3-goodpart.gpf'),loglevel=100)
